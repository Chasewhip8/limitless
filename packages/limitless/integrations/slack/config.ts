...
export const MAX_SLACK_ATTACHMENTS_PER_TURN = 4
export const MAX_SLACK_MEDIA_BYTES = 10 * 1024 * 1024
export const MAX_SLACK_TEXT_FILE_BYTES = 512 * 1024
export const MAX_SLACK_TEXT_BYTES_PER_TURN = 1024 * 1024
export const MAX_SLACK_FILE_INFO_REQUESTS_PER_TURN = 8
export const MAX_SLACK_OUTBOUND_FILES_PER_TURN = 10
export const MAX_SLACK_OUTBOUND_FILE_BYTES = 100 * 1024 * 1024
export const MAX_SLACK_OUTBOUND_BYTES_PER_TURN = 512 * 1024 * 1024
export const MAX_SLACK_OUTBOUND_BYTES_PROCESS = 512 * 1024 * 1024
export const SLACK_OUTBOUND_UPLOAD_TIMEOUT_MS = 10 * 60 * 1000
export const MAX_SLACK_IMAGES_PER_TURN = MAX_SLACK_ATTACHMENTS_PER_TURN
export const MAX_SLACK_IMAGE_BYTES = MAX_SLACK_MEDIA_BYTES
